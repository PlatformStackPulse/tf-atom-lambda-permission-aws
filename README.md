# tf-atom-lambda-permission-aws

[![CI](https://github.com/PlatformStackPulse/tf-atom-lambda-permission-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-lambda-permission-aws/actions/workflows/ci.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)

## Purpose

Terraform atom: AWS Lambda Permission - grants a service permission to invoke a Lambda function.
...
|------|-------------|------|---------|:--------:|
| <a name="input_function_name"></a> [function\_name](#input\_function\_name) | Name or ARN of the Lambda function | `string` | n/a | yes |
| <a name="input_principal"></a> [principal](#input\_principal) | Principal to grant permission to | `string` | n/a | yes |
| <a name="input_action"></a> [action](#input\_action) | The AWS Lambda action to allow | `string` | `"lambda:InvokeFunction"` | no |
...
| <a name="input_source_arn"></a> [source\_arn](#input\_source\_arn) | ARN of the source triggering the Lambda | `string` | `null` | no |
...
| <a name="output_statement_id"></a> [statement\_id](#output\_statement\_id) | Statement ID of the permission |
<!-- END_TF_DOCS -->
